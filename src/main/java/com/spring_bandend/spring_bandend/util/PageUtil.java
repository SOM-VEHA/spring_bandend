package com.spring_bandend.spring_bandend.util;
import org.springframework.data.domain.PageRequest;
import org.springframework.data.domain.Pageable;
import com.spring_bandend.spring_bandend.dto.filter.BaseFilter;
import com.spring_bandend.spring_bandend.dto.filter.PageSortFilter;
import org.springframework.data.domain.PageRequest;
import org.springframework.data.domain.Pageable;
...
public final class PageUtil {
    ...
    public static Sort sort(PageSortFilter filter, String defaultSortField, Collection<String> allowedSortFields) {
